...
for row in rows:
    unrate=row.split(',')
    unrates.append(unrate)
#print(unrates)
first_twelve=unrates[1:13]
print (first_twelve)
xaxis=[]
data=[]
for monthly_data in first_twelve:
    xaxis.append(monthly_data[0])
    data.append(monthly_data[1])
#xaxis.append(unrates)
